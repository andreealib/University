...
public class ProfessorCourseHandlerDAOImpl extends JdbcDaoSupport implements ProfessorCourseHandlerDAO {
    ...
    public List<ProfessorCourseHandler> findAllCoursesForProfessor(int idprofessor) {
        String SQL = "select pch.idprofessor,pch.idcourse from professor_course_handler pch,professors where professors.idprofessor=pch.idprofessor and professors.idprofessor=?";
    ...
    public List<ProfessorCourseHandler> findAllProfessorsForCourse(int idcourse) {
        String SQL = "select pch.idprofessor,pch.idcourse from professor_course_handler pch,courses where courses.idcourse=pch.idcourse and courses.idcourse=?";
    ...
    public void insert(ProfessorCourseHandler professorCourseHandler) {
        String SQL = "insert into professor_course_handler (idprofessor,idcourse) value(?,?) ";
        for(long idcourse:professorCourseHandler.getIdcourses()){
            Object[] object = new Object[]{professorCourseHandler.getIdprofessor(), idcourse};
